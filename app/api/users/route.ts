...
//     // Generate a default password if not provided and no clerkId
//     let hashedPassword;
//     if (!clerkId) {
...
// // -------------------------
// // GET: Get users (by ID, clerkId, or all) (ADMIN/MANAGER)
// // -------------------------
...
//     // Search by MongoDB _id if provided
//     if (userId) {
...
// // -------------------------
// // PUT: Update a user (ADMIN/MANAGER only)
// // -------------------------
...
// // -------------------------
// // DELETE: Delete a user (ADMIN/MANAGER only)
// // -------------------------
...
export async function GET(req: NextRequest) {
  try {
    ...
    // ✅ FIXED: Fetch ALL users (both with and without clerkId)
    ...
    console.log(
      ...
      users.slice(0, 3).map((u) => ({
        ...
        name: u.name,
        email: u.email,
        clerkId: u.clerkId || "NO CLERK ID (old user)",
    ...
    const formattedUsers = users.map((user) => ({
      ...
      name: user.name,
      email: user.email,
      role: user.role, // This is an array
